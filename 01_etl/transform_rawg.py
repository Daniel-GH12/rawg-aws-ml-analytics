# =========================================================================
# === FUNCIÓN TRANSFORMACIÓN COMPLETA DE DATOS EXTRAÍDOS DE LA API RAWG ===
# =========================================================================
...
def extraer_ratings_distribution(game):
    ...
    """Extrae los ratings_distribution (lista de 4 elementos)
...
def extraer_stores(game):
    import pandas as pd
    import json
    """Extrae las tiendas donde está disponible el juego
    Retorna: lista de diccionarios"""
    game_id = game.get('id')    
...
def transformar_juego_completo(game):
    ...
    """
    Transforma datos extraídos de RAWG en DataFrames normalizados
    
    Args:
        datos: dict con los datos JSON
...
def transf_rawg_data(datos, verbose = False):

    import json
    import pandas as pd
    # Transforma datos brutos de RAWG en DataFrames normalizados
    if verbose:
...
if __name__ == "__main__":
    print("Módulo transformation_data_rawg.py")